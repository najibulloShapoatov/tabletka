    ...
    <div class="row">
        <div class="col-12 mb-30">
            <button data-id="0" id="ad_cat_btn" class="button button-my float-right"><span><i class="ti-plus"></i>Добавить</span></button>
        </div>
                            ...
                            @foreach($cats as $item)
                                ...
                                <tr id="table_item_adm_{{ $item->id }}">
                                    ...
                                    <td width="170" class="text-center act"  style="vertical-align: middle">
                                        ...
                                        <span data-id="{{ $item->id }}" id="show_category" class="ti-menu edit-item mr-10"></span>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button data-id="0" id="save_category" class="button button-primary button-my">Сохранить</button>
                    </div>
                </div>
            </div>
        </div>
