        ...
        <div class="page-header border-bottom mb-8">
            <div class="container">
                <div class="d-md-flex justify-content-between align-items-center py-4">
                    <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">Каталог</h1>
                    {{--
...
{{--                                        <option {{ ($sort == 'popularity')? 'selected':'' }} value="popularity">Самые популярные</option>--}}
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-one-example1" role="tabpanel" aria-labelledby="pills-one-example1-tab">
                                ...
                                <ul class="products list-unstyled row no-gutters row-cols-2 row-cols-lg-3 row-cols-wd-4 ml-3 mb-6">
